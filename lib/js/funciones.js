...
//encargaa de verificar el navegador
function chrome(){
...
function registro(id){
  ...
  nombre=formulario.nombre.value,apellido=formulario.apellido.value,cedula=formulario.cedula.value,twitter=formulario.twitter.value,email=formulario.email.value,nomform=formulario.id;
    ...
    conexion.send('nombre='+nombre+'&apellido='+apellido+'&cedula='+cedula+'&twitter='+twitter+'&email='+email+'&formulario='+nomform);
  }
